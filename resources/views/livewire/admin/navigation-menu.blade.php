<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('admin.competitions') }}" :active="request()->routeIs('admin.competitions')">
                {{ __('Competitions') }}
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="{{ route('admin.calendars') }}" :active="request()->routeIs('admin.calendars')">
                {{ __('Calendars') }}
            </x-jet-responsive-nav-link>
        </div>
