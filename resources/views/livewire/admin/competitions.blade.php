                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed">
                        <thead>
                            <tr>
                                ...
                                <th class="w-1/12 px-2 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">{{ __('Number') }}</th>
                                    ...
                                    <tr>
                                        @php
                                            if($item->competition_date != null) {
                                                $formattedDate = $item->competition_date->format('d-m-y');
                                            } else {
