            ...
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        ...
                        @endphp
                        <a href="{{ route($route) }}" class="text-sm text-gray-700 underline">{{ $homeText }}</a>
                    @else
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Voor de leden is er op dit moment één functionaliteit die in test is. Leden die willen testen, kunnen na registratie de samenstelling van de ploegen voor elke competitie vastleggen. Vermits dit nog in test is, zal dit bij 'live' gaan van de echte server opnieuw moeten aangevuld worden. Ondertussen kan u natuurlijk al het één en ander uitproberen !
                                </div>
                            </div>
                        </div>
